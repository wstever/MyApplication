package com.example.burt.android_sample_study.recycler_view;
...
public class RecyclerLayoutManagerChangeActivity extends Activity {
                        ...
                        if (position == 0) {
                            mRcList.setLayoutManager(
                                    ...
                                    new LinearLayoutManager(
                                            RecyclerLayoutManagerChangeActivity.this));
                        } else if (position == 1) {
                            mRcList.setLayoutManager(
                                    // 设置为表格布局
                                    new GridLayoutManager(
                                            RecyclerLayoutManagerChangeActivity.this, 3));
                        } else if (position == 2) {
                        }
                    }
