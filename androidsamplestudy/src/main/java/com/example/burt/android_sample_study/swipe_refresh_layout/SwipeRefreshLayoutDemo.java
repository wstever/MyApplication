package com.example.burt.android_sample_study.swipe_refresh_layout;
...
public class SwipeRefreshLayoutDemo extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footerView = getLayoutInflater().inflate(R.layout.swipe_refresh_loading_layout, null);
        lv.addFooterView(footerView);
        lv.setOnScrollListener(this);
        list = new ArrayList<>();
        list.addAll(Arrays.asList("Java", "php", "C++", "www"));
